...
(function (b) {
    ...
    b(function () {
        ...
        b(".owl-carousel").each(function () {
            ...
            a.owlCarousel({
                ...
                navText: [
                    '<i class="fa fm fa-arrow-left"></i>', '<i class="fa flm fa-arrow-right"></i>'
                ],
        ...
        b("[data-countdown]").each(function () {
            ...
            a.countdown(a.data("countdown"), function (a) {
                b(this).html("<ul>" + a.strftime("<li><strong>%D</strong><span>Days</span></li><li><strong>%H</strong><span>Hours<" +
                        "/span></li><li><strong>%M</strong><span>Minutes</span></li><li><strong>%S</stron" +
                        "g><span>Seconds</span></li>") + "</ul>")
            })
        });
    ...
    m.on("load", function () {
        var c = function () {
            1 < m.scrollTop()
                ? n.addClass("isScrolling")
                : n.removeClass("isScrolling")
        };
        c();
        m.on("scroll", c);
        c = b(".AdjustRow");
        c.length && c.isotope({layoutMode: "fitRows"});
        c = b(".MasonryRow");
        c.length && c.isotope();
        ...
        c.length && c
            .find(".logo, .header--navbar-top-btn, .header--navbar-top-info")
        ...
        k.length && (k.directionalHover({overlay: ".gallery--info"}), c.find('[data-popup="img"]').on("mfpClose", function (a) {
            k.directionalHover({overlay: ".gallery--info"})
        }));
        h.length && h.isotope({animationEngine: "best-available", itemSelector: ".gallery--item"});
